...
class Editor:
    def __init__(self):  
        ...
        # We want to render onto the display, which is half the size of the screen, then scale it up
    ...
    def run(self):
        while True:
            ...
            mpos = (mpos[0] , mpos[1])
            mpos = (mpos[0] * self.zoom, mpos[1] * self.zoom)
            ...
            self.screen.blit(current_tile_img, (5, 5)) # shows what tile we are using in top left
            ...
            for event in pygame.event.get():
                ...
                # Checking key inputs, moving or responding to key up/ down
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_z:
                        self.screen_size[0] = int(self.screen_size[0]) * 2 
                        self.screen_size[1] = int(self.screen_size[1]) * 2 
                        self.zoom *= 2
